...
<h2 class="panel-title"><i class="fa fa-bar-chart-o fa-fw"></i>Reporte de sitios más visitados</h2>
...
$dompdf->render();
$dompdf->stream("Reporte_sitios_mas_visitados.pdf");