...
<section class="container container-fluid">
            ...
            <form class="form-horizontal" action="<?php echo url("usuario/crear") ?>" method="post">
               ...
               <div class="form-group">
                    <div class="col-sm-offset-2 col-sm-10">
                        ...
                        <button type="submit" class="btn btn-primary btn-block btn-lg visible-xs">Guardar</button>
